      ...
      <div className="top-0 z-40 fixed   backdrop-filter backdrop-blur-3xl shadow md:shadow-none bg-white/60 w-full transition duration-700">
         <div className="flex justify-between items-center w-full  z-50  px-4 md:px-20 py-5">
            ...
            <img src={logo} alt="Logo" className="md:w-72 w-32" />
               ...
               <h1 className="text-2xl md:text-4xl  font-bold text-[#3295DC]">
                  ABSOLUTEPITCH
               </h1>
            </div>
            ...
            <div className="md:flex hidden items-center space-x-[72px] text-black text-xs md:text-lg">
               ...
               <div className="flex items-center justify-between rounded-md   pl-4 py-2 pr-2 bg-[#3295DC] text-white cursor-pointer">
                  <a
                     href="/"
